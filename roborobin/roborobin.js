...
/* ── LOGOUT / SESSION (la verificación real la hace el guardia inline en index.html) ── */
function doLogout() {
  sessionStorage.removeItem('ok_session_v3');
  localStorage.removeItem('ok_session_v3');
  window.location.href = '../login/';
}

function getUserFromSession() {
  return window.__OK_USER__ || 'Usuario';
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (hu) hu.textContent = getUserFromSession();
});
